...
OO.Ads.manager(function(_, $)
{
  ...
  var SsaiPulse = function()
  {
    ...
    var _appendAdsProxyQueryParameters = _.bind(function(url, adId)
    {
      ...
      var adTagParam = AD_TAG_PARAM + gender;
      newUrl = _appendParamToUrl(newUrl, adTagParam);
      return newUrl;
    }, this);
